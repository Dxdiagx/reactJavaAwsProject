...
class UserDetails extends Component {
  ...
  state = {
    ...
    interests: this.props.userdata.interests,
    editClicked: false,
  };

  render() {
    <FileGridList email={this.props.userdata.email} />;
    return (
      <div>
        <NavbarLoginPage />
                      ...
                      <td>
                        {this.state.editClicked == false ? (
                          ...
                          <input
                            ...
                            required
                            autoFocus
                            defaultValue={this.props.userdata.contact}
                            onChange={(event) => {
                              this.setState({
                                contact:
                                  event.target.value == ""
